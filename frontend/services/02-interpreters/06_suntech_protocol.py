...
class SuntechProtocolService(BaseService):
    @property
    def service_name(self) -> str:
        """Return the name of the service, which matches the database table name."""
        return "suntechprotocol"  # This must match the database table name
                ...
                "spec": {
                    ...
                    "template": {
                        ...
                        "spec": {
                            ...
                            "containers": [{
                                "name": "suntechprotocol",
                                "image": "maddsystems/suntechprotocol:1.0.0",
