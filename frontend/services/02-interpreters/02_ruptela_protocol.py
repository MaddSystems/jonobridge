...
class RuptelaProtocolService(BaseService):
    @property
    def service_name(self) -> str:
        """Return the name of the service, which matches the database table name."""
        return "ruptelaprotocol"  # This must match the database table name
                ...
                "spec": {
                    ...
                    "template": {
                        ...
                        "spec": {
                            ...
                            "containers": [{
                                "name": "ruptelaprotocol",
                                "image": "maddsystems/ruptelaprotocol:1.0.0",
