...
class QueclinkProtocolService(BaseService):
    @property
    def service_name(self) -> str:
        """Return the name of the service, which matches the database table name."""
        return "queclinkprotocol"  # This must match the database table name
                ...
                "spec": {
                    ...
                    "template": {
                        ...
                        "spec": {
                            ...
                            "containers": [{
                                "name": "queclinkprotocol",
                                "image": "maddsystems/queclinkprotocol:1.0.0",
