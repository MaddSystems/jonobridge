...
class Controlnavigation(BaseService):
    @property
    def service_name(self) -> str:
        """Return the name of the service, which matches the database table name."""
        return "controlnavigation"  # This must match the database table name
    ...
    def parameters_helpers(self) -> Dict[str, str]:
        ...
        return {
            "controlnavigation_user": ["default_user"],
            "controlnavigation_user_key": ["default_key"],
            "controlnavigation_url": ["http://control.navigation.com.mx/WSNavMex/geonav/comandos/posicion"],
            "controlnavigation_token_url": ["http://control.navigation.com.mx/WSNavMex/geonav/autenticacion/autenticar"],
            "elastic_doc_name": ["controlnavigation"],
    ...
    def parameters(self) -> Dict[str, str]:
        ...
        return {
            ...
            "controlnavigation_url": "varchar(255)",
            "controlnavigation_token_url": "varchar(255)",
                ...
                "spec": {
                    ...
                    "template": {
                        ...
                        "spec": {
                            ...
                            "containers": [{
                                "name": "controlnavigation",
                                "image": "maddsystems/controlnavigation:1.0.0",
                                ...
                                "env": [
                                    ...
                                    {
                                        "name": "CONTROLNAVIGATION_USER",
                                        "value": None
                                    }
                                    ,
                                    {
                                        "name": "CONTROLNAVIGATION_USER_KEY",
                                        "value": None
                                    }
                                    ,
                                    {
                                        "name": "CONTROLNAVIGATION_URL",
                                        "value": None
                                    }
                                    ,
                                    {
                                        "name": "CONTROLNAVIGATION_TOKEN_URL",
                                        "value": None
                                    }
                                    ,
                                    {
    ...
    def _customize_manifests(self, templates: Dict[str, Any], client_name: str, params: Dict[str, Any]) -> None:
        ...
        for env in container["env"]:
            if env["name"] == "CONTROLNAVIGATION_USER":
                env["value"] = params["controlnavigation_user"]
            if env["name"] == "CONTROLNAVIGATION_USER_KEY":
                env["value"] = params["controlnavigation_user_key"]
            if env["name"] == "CONTROLNAVIGATION_URL":
                env["value"] = params["controlnavigation_url"]
            if env["name"] == "CONTROLNAVIGATION_TOKEN_URL":
                env["value"] = params["controlnavigation_token_url"]
