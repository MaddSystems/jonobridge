...
class Rfl3Service(BaseService):
    @property
    def service_name(self) -> str:
        """Return the name of the service, which matches the database table name."""
        return "rfl3"  # This must match the database table name
    ...
    def parameters_helpers(self) -> Dict[str, str]:
        ...
        return {
            "plates_url": ["https://pluto.dudewhereismy.com.mx/imei/search?appId=822"],
            ...
            "elastic_doc_name": ["gruas_aya_rfl3"],
    ...
    def parameters(self) -> Dict[str, str]:
        ...
        return {
            ...
            "rfl3_url": "varchar(255)",
            "rfl3_xapikey": "varchar(255)",
    ...
    def _customize_manifests(self, templates: Dict[str, Any], client_name: str, params: Dict[str, Any]) -> None:
        ...
        for env in container["env"]:
            ...
            if env["name"] == "RFL3_URL":
                env["value"] = params["rfl3_url"]
            if env["name"] == "RFL3_XAPIKEY":
                env["value"] = params["rfl3_xapikey"]
