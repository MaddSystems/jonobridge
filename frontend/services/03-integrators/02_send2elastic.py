...
class Send2ElasticService(BaseService):
    @property
    def service_name(self) -> str:
        """Return the name of the service, which matches the database table name."""
        return "send2elastic"  # This must match the database table name
                ...
                "spec": {
                    ...
                    "template": {
                        ...
                        "spec": {
                            ...
                            "containers": [{
                                "name": "send2elastic",
                                "image": "maddsystems/send2elastic:1.0.0",
