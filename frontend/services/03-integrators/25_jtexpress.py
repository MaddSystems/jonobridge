...
class JtexpressService(BaseService):
    @property
    def service_name(self) -> str:
        """Return the name of the service, which matches the database table name."""
        return "jtexpress"  # This must match the database table name
    ...
    def parameters_helpers(self) -> Dict[str, str]:
        ...
        return {
            ...
            "jtexpress_url": ["https://openapi.jtjms-mx.com/webopenplatformapi/transport/gps/trajectoryUpload"],
            "jtexpress_api_account": ["845706127613108275"],
            "jtexpress_private_key": ["b0333a47b3a54e3e8765ffe0f8b39cba"],
            "elastic_doc_name": ["jtexpress"],
    ...
    def parameters(self) -> Dict[str, str]:
        ...
        return {
            ...
            "jtexpress_url": "varchar(255)",
            "jtexpress_api_account": "varchar(255)",
            "jtexpress_private_key": "varchar(255)",
                ...
                "spec": {
                    ...
                    "template": {
                        ...
                        "spec": {
                            ...
                            "containers": [{
                                "name": "jtexpress",
                                "image": "maddsystems/jtexpress:1.0.0",
                                ...
                                "env": [
                                    ...
                                    {
                                        "name": "JTEXPRESS_API_ACCOUNT",
                                        "value": None
                                    },
                                    {
                                        "name": "JTEXPRESS_PRIVATE_KEY",
                                        "value": None
                                    },
                                    {
    ...
    def _customize_manifests(self, templates: Dict[str, Any], client_name: str, params: Dict[str, Any]) -> None:
        ...
        for env in container["env"]:
            ...
            if env["name"] == "JTEXPRESS_URL":
                env["value"] = params["jtexpress_url"]
            if env["name"] == "JTEXPRESS_API_ACCOUNT":
                env["value"] = params["jtexpress_api_account"]
            if env["name"] == "JTEXPRESS_PRIVATE_KEY":
                env["value"] = params["jtexpress_private_key"]
