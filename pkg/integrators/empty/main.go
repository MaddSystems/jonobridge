...
import (
	altotrackintegrator "altotrack/features/altotrack_integrator"
	"flag"
	"fmt"
	"log"
	"os"
...
func main() {
	...
	fmt.Println("token length:", len(altotrackToken))
	fmt.Println("url:", altotrackURL)
	...
	opts.SetDefaultPublishHandler(func(client mqtt.Client, msg mqtt.Message) {
		...
		altotrackintegrator.Init(string(msg.Payload()))
