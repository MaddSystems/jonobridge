package altotrackintegrator

import (
	"altotrack/features/altotrack_integrator/data"
	"altotrack/features/altotrack_integrator/usecases"
	"encoding/json"
	"fmt"
...
// Initialize sets up any required resources for the Altotrack integrator
func Initialize() {
	// Initialize Altotrack
	data.InitAltotrack()
	utils.VPrint("Altotrack integrator initialized")
}
