...
import (
	controlnavigationintegrator "controlnavigation/features/controlnavigation_integrator"
	"flag"
	"fmt"
	"log"
	"os"
...
func main() {
	...
	controlnavigationintegrator.Initialize()
	...
	clientID := fmt.Sprintf("CONTROLNAVIGATION_%s_%s_%d",
		"CONTROLNAVIGATION",
		os.Getenv("HOSTNAME"),
	...
	opts.SetDefaultPublishHandler(func(client mqtt.Client, msg mqtt.Message) {
		...
		controlnavigationintegrator.Init(string(msg.Payload()))
