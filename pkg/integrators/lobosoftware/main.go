...
import (
	"flag"
	"fmt"
	lobosoftwareintegrator "lobosoftware/features/lobosoftware_integrator"
	"log"
	"os"
	"time"
...
func main() {
	...
	lobosoftwareintegrator.Initialize()
	...
	clientID := fmt.Sprintf("LOBOSOFTWARE_%s_%s_%d",
		"LOBOSOFTWARE",
		os.Getenv("HOSTNAME"),
	...
	opts.SetDefaultPublishHandler(func(client mqtt.Client, msg mqtt.Message) {
		...
		lobosoftwareintegrator.Init(string(msg.Payload()))
