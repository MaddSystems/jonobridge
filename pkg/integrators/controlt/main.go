...
import (
	controltintegrator "controlt/features/controlt_integrator"
	"flag"
	"fmt"
	"log"
	"os"
...
func main() {
	...
	clientID := fmt.Sprintf("CONTROLT_%s_%s_%d",
		"CONTROLT",
		os.Getenv("HOSTNAME"),
	...
	opts.SetDefaultPublishHandler(func(client mqtt.Client, msg mqtt.Message) {
		...
		controltintegrator.Init(string(msg.Payload()))
