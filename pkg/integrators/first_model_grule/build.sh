...
CGO_ENABLED=0 go build -o grule-engine
...
# . refers to the current directory as the build context (repo root)
docker build -f pkg/integrators/grule/Dockerfile -t "${FULL_IMAGE_NAME}" .
