...
import (
	"flag"
	"fmt"
	gpsinfointegrator "gpsinfo/features/gpsinfo_integrator"
	"log"
	"os"
	"time"
...
func main() {
	...
	clientID := fmt.Sprintf("GPSINFO_%s_%s_%d",
		"GPSINFO",
		os.Getenv("HOSTNAME"),
	...
	opts.SetDefaultPublishHandler(func(client mqtt.Client, msg mqtt.Message) {
		...
		gpsinfointegrator.Init(string(msg.Payload()))
