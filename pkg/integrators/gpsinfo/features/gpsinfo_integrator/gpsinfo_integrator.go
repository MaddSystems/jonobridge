package gpsinfointegrator

import (
	"gpsinfo/features/gpsinfo_integrator/data"
	"gpsinfo/features/gpsinfo_integrator/usecases"
	"encoding/json"
	"fmt"
...
// Initialize sets up any required resources for the Gpsinfo integrator
func Initialize() {
	// Initialize Gpsinfo
	data.InitGpsinfo()
	utils.VPrint("Gpsinfo integrator initialized")
}
