...
import (
	alephriintegrator "alephri/features/alephri_integrator"
	"flag"
	"fmt"
	"log"
	"os"
...
func main() {
	...
	clientID := fmt.Sprintf("ALEPHRI_%s_%s_%d",
		"ALEPHRI",
		os.Getenv("HOSTNAME"),
	...
	opts.SetDefaultPublishHandler(func(client mqtt.Client, msg mqtt.Message) {
		...
		alephriintegrator.Init(string(msg.Payload()))
