...
import (
	...
	"log"
	"os"
	telemetryintegrator "telemetry/features/telemetry_integrator"
	"time"
...
func main() {
	...
	telemetryintegrator.Initialize()
	...
	clientID := fmt.Sprintf("TELEMETRY_%s_%s_%d",
		"TELEMETRY",
		os.Getenv("HOSTNAME"),
	...
	opts.SetDefaultPublishHandler(func(client mqtt.Client, msg mqtt.Message) {
		...
		telemetryintegrator.Init(string(msg.Payload()))
