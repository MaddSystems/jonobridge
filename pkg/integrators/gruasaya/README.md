...
{"localaddress": ["l", "138.68.54.137", ":8611", "Local address", "meitrack"], "protocol": "meitrack", "transport": "udp", "integratorRemote": [{"name": "AltoTrack", "configuration": ["33", "http://ws4.gruasaya.com/WSPosiciones_WalmartMX/WSPosiciones_WalmartMX.svc?wsdl/IServicePositions", "", "meitrack"]}]}
```
...
find . -type f -exec sed -i -e 's/GRUASAYA/AVOCADOCLOUD/g' -e 's/gruasaya/avocadocloud/g' -e 's/Gruasaya/Avocadocloud/g' {} \;
