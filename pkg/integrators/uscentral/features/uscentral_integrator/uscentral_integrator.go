package uscentralintegrator

import (
	"uscentral/features/uscentral_integrator/data"
	"uscentral/features/uscentral_integrator/usecases"
	"encoding/json"
	"fmt"
...
// Initialize sets up any required resources for the Uscentral integrator
func Initialize() {
	// Initialize Uscentral
	data.InitUscentral()
	utils.VPrint("Uscentral integrator initialized")
}
