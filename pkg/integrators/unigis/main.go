package main // This should be the correct declaration for an executable
...
import (
	...
	"os"
	"time"
	unigisintegrator "unigis/features/unigis_integrator"
...
func main() {
	...
	clientID := fmt.Sprintf("UNIGIS_%s_%s_%d",
		"UNIGIS",
		os.Getenv("HOSTNAME"),
	...
	opts.SetDefaultPublishHandler(func(client mqtt.Client, msg mqtt.Message) {
		...
		unigisintegrator.Init(string(msg.Payload()))
