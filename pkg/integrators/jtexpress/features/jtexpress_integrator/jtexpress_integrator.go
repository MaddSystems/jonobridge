package jtexpressintegrator

import (
	"jtexpress/features/jtexpress_integrator/data"
	"jtexpress/features/jtexpress_integrator/usecases"
	"encoding/json"
	"fmt"
...
// Initialize sets up any required resources for the Jtexpress integrator
func Initialize() {
	// Initialize Jtexpress
	data.InitJtexpress()
	utils.VPrint("Jtexpress integrator initialized")
}
