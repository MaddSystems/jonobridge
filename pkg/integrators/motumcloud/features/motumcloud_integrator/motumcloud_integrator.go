package motumcloudintegrator

import (
	"motumcloud/features/motumcloud_integrator/data"
	"motumcloud/features/motumcloud_integrator/usecases"
	"encoding/json"
	"fmt"
...
// Initialize sets up any required resources for the Motumcloud integrator
func Initialize() {
	// Initialize Motumcloud
	data.InitMotumcloud()
	utils.VPrint("Motumcloud integrator initialized")
}
