...
import (
	...
	"fmt"
	"log"
	motumcloudintegrator "motumcloud/features/motumcloud_integrator"
	"os"
	"time"
...
func main() {
	...
	motumcloudintegrator.Initialize()
	...
	clientID := fmt.Sprintf("MOTUMCLOUD_%s_%s_%d",
		"MOTUMCLOUD",
		os.Getenv("HOSTNAME"),
	...
	opts.SetCleanSession(false) // Maintain persistent sessiongo
	...
	opts.SetDefaultPublishHandler(func(client mqtt.Client, msg mqtt.Message) {
		...
		motumcloudintegrator.Init(string(msg.Payload()))
